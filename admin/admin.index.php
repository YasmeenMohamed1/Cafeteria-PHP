...
<div class="container mt-5">
    ...
    <label for="select">Add to User:</label>
    
        <select class="form-select" id="user_select" name="user_select" required>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetch_data(page) {
            $.ajax({
                url: "../user/cart/get_all_product_with_pagination.php",
                method: "POST",
                data: {
                    page: page
                },
       ...
       //set data to cart
        ...
        //    alert("id" + id + ", name" + name + ", price" + price + ", quantity" + quantity)
            $.ajax({
                method: "POST",
                url: "../user/cart/add_product_to_cart.php",
                data: {
                    id: id,
                    name: name,
                    price: price,
